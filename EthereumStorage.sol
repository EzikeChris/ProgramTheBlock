...
The Solidity documentation covers the layout of state variables in storage.
Howard’s excellent series on the EVM includes two relevant parts: Storage Layout and The Hidden Costs of Arrays
← Writing a Collateralized Loan ContractWriting an ERC20 Pawnshop Contract →
